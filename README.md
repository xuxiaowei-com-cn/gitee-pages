...
$ go run main.go --help
NAME:
   gitee-pages - 基于 Go 语言开发的 Gitee Pages 命令行工具

USAGE:
   gitee-pages [global options] command [command options]
